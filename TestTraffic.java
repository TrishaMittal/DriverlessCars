...
public class TestTraffic {
	...
	public void startGui() {
		...
		TrafficSignal ts3 = new TrafficSignal(i4, 5000);
		i4.setTrafficControl(ts3);
		
		TrafficSignal ts4 = new TrafficSignal(i5, 8000);
		i5.setTrafficControl(ts4);
		
		TrafficSignal ts5 = new TrafficSignal(i6, 5000);
		i6.setTrafficControl(ts5);
		
		TrafficSignal ts6 = new TrafficSignal(i1, 8000);
		i1.setTrafficControl(ts6);
		
		Car car1 = new TestCar53();
		car1.setInitialPos(r1, i1.getCoords(), RoadGrid.EAST);
		
		Car car2 = new TestCar53();
		car2.setInitialPos(r2, i2.getCoords(), RoadGrid.SOUTH);
		
		Car car3 = new TestCar08();
		car3.setInitialPos(r2, i3.getCoords(), RoadGrid.NORTH);
		
		Car car4 = new TestCar53();
		car4.setInitialPos(r4, i4.getCoords(), RoadGrid.WEST);
		
		Car car5 = new TestCar08();
		car5.setInitialPos(r5, i5.getCoords(), RoadGrid.WEST);
		
		
		Car car6 = new TestCar53();
		car6.setInitialPos(r6, i6.getCoords(), RoadGrid.NORTH);
		
		Car car7 = new TestCar08();
		car7.setInitialPos(r7, i7.getCoords(), RoadGrid.EAST);
		
		Car car8 = new TestCar53();
